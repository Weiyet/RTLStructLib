# List pyUVM VIP - Quick Start Guide
...
1. **list_simple_test** - Insert, read, sum, sort operations
2. **list_random_test** - Random mixed operations (insert/read/delete/find/sort)

## 🔧 Customize DUT Parameters

Edit the `Makefile` to change List parameters:

```makefile
COMPILE_ARGS = -Plist.DATA_WIDTH=8     # Change data width
COMPILE_ARGS += -Plist.LENGTH=8         # Change max length
COMPILE_ARGS += -Plist.SUM_METHOD=0     # Change sum method
```
...
```
============================================================
Starting List Simple Test (pyUVM)
============================================================
DUT Parameters: DATA_WIDTH=8, LENGTH=8, SUM_METHOD=0
DUT initialization complete
Test: Inserting 5 items
Test: Reading 5 items
Test: Summing items
Test: Sorting ascending
Test: Reading after sort
============================================================
List Simple Test Complete
============================================================
```
...
| **View waves** | Open in simulator | `gtkwave list.vcd` |
...
2. **Study the code** - Start with `tb_list.py`, then explore agent/
3. **Modify tests** - Edit `tests/list_vip_simple_test.py`
