"""
Doubly Linked List VIP Driver
Create Date: 01/05/2026

Driver for Doubly Linked List VIP - drives transactions to DUT
"""
...
class DllVipDriver(uvm_driver):
    """Driver for Doubly Linked List VIP"""
    ...
    async def drive_item(self, item):
        ...
        # Capture outputs (including both prev and next pointers for doubly linked)
