"""
Doubly Linked List VIP Configuration
Create Date: 01/05/2026

Configuration class for Doubly Linked List VIP
"""

from pyuvm import *


class DllVipConfig(uvm_object):
    """Configuration object for Doubly Linked List VIP"""

    def __init__(self, name="dll_vip_config"):
        super().__init__(name)
