"""
Doubly Linked List VIP Base Test
Create Date: 01/05/2026

Base test class for Doubly Linked List VIP
"""

from pyuvm import *
from cocotb.triggers import Timer
from ..env.dll_vip_env import DllVipEnv
from ..common.dll_vip_config import DllVipConfig


class BaseTest(uvm_test):
    """Base test for Doubly Linked List VIP"""
    ...
    def build_phase(self):
        ...
        self.cfg = DllVipConfig("dll_vip_cfg")

        # Get DUT parameters from cocotb
        dut = ConfigDB().get(None, "", "dll_vip_dut")
        if dut:
            try:
        ...
        # Set config
        ConfigDB().set(None, "*", "dll_vip_cfg", self.cfg)

        # Create environment
        self.env = DllVipEnv("env", self)
