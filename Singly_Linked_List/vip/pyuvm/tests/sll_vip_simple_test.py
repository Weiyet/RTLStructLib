"""
Singly Linked List VIP Simple Test
...
from .sll_vip_base_test import BaseTest
...
class SimpleTest(BaseTest):
    """Simple test for Singly Linked List VIP"""
    ...
    async def run_phase(self):
        ...
        # Read again
        read_seq2 = SllVipReadSeq("read_after_delete")
...
class RandomTest(BaseTest):
    ...
    async def run_phase(self):
        ...
        insert_seq = SllVipInsertSeq("init_insert")
        insert_seq.num_inserts = 5
        ...
        for i in range(3):
            # Insert with index
            insert_seq = SllVipInsertSeq(f"insert_{i}")
            ...
            # Read
            read_seq = SllVipReadSeq(f"read_{i}")
            ...
            # Delete by value
            delete_seq = SllVipDeleteSeq(f"delete_{i}")
        ...
        # Final operations
        read_seq = SllVipReadSeq("final_read")
        ...
        # Delete by index
        delete_seq = SllVipDeleteSeq("final_delete")
        delete_seq.num_deletes = 2
